...
Operation & TOCTOU, action rebinding & E & Zero-Permission Manipulation (``Action Rebinding'')~\cite{qian2026zero}, Hijacking JARVIS (``AgentHazard'')~\cite{liu2025hijacking} \\
Operation & Clickjacking, visual anchors & E & Chameleon~\cite{zhang2026realistic}, WAInjectBench~\cite{liu2025wainjectbench} \\
Operation & IPI, EIA & M or C & InjecAgent~\cite{zhan2024injecagent}, WASP~\cite{evtimov2025wasp}, Chameleon~\cite{zhang2026realistic} \\
Operation & Memory/RAG poisoning & M & AgentPoison~\cite{chen2024agentpoison} \\
Operation & Curiosity-driven overreach, PII leakage & C or M & AgentDAM~\cite{zharmagambetov2025agentdam}, SafeArena~\cite{tur2025safearena} \\
Operation & Agent-to-agent propagation & C or M & Chen~\cite{chen2026openclaw}, Prompt Infection~\cite{lee2024prompt} \\
